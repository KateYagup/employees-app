...
const Navigation = () => {
  ...
  return (
    <div className="navigationBar">
      <div className="navigation">
        <div className="navigation__content">
          ...
          <input
            ...
            value={searchText}
            onChange={e => {
              setSearchText(e.target.value), handleSearchText(e);
            }}
      ...
      <div className="positions">
        {positionsButtons.map(pos => {
          return (
            <button
              className={
                pos.id == activePosition ? 'filterPosition activeFilter' : 'filterPosition'
              }
              value={pos.id}
      ...
      {visibleSortWindow && <SortWindow setVisibleSortWindow={setVisibleSortWindow} />}
    </div>
  );
};
